...
Las variables de entrada para `metagen()` serán `mean` (diferencia de medias estandarizada), `SE` (variabilidad de la estimación) y `author` (identificador único del estudio):
